...
public class WhateverUIController {

    private static final Logger log = LoggerFactory.getLogger(WhateverUIController.class);

    private final String page = "/WEB-INF/jsp/whatever/whatever.jsp";
